...
public class CarChoice extends AppCompatActivity implements View.OnClickListener {
    ...
    public void UpdateTable(){
        ...
        if (cursor.moveToFirst()) {
            ...
            int startRouteIndex = cursor.getColumnIndex(DBHelper.KEY_CARBRAND);
            int endRouteIndex = cursor.getColumnIndex(DBHelper.KEY_CARMODEL);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buy:
                if(kol != 0){
                    Toast.makeText(this, "Вы приобрели " + kol + " автомобиль(-ей) по цене " + summa + " рублей", Toast.LENGTH_LONG).show();
                    kol = 0;
                    count = "Количество:\n" + kol;
                    ...
                    Toast.makeText(this, "В корзину не добавлен ни один автомобиль", Toast.LENGTH_LONG).show();
                }
                break;
            default:
